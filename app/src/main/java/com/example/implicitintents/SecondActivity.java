...
public class SecondActivity extends AppCompatActivity {
    public static final String EXTRA_ITEMS = "com.example.implicitintents.extra.ITEMS";
    ...
    public void selectItem(View view) {
        ...
        switch (view.getId()){
            ...
            case R.id.button_salt:
                ...
                break;
            default:
                Toast.makeText(com.example.implicitintents.SecondActivity.this, "There was an error", Toast.LENGTH_LONG).show();
                break;
        }
